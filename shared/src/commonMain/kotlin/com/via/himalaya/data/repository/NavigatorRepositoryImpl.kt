...
class NavigatorRepositoryImpl(databaseDriverFactory: DatabaseDriverFactory) : NavigatorRepository {
    ...
    override suspend fun startNewNavigator(
        name: String,
        guideId: String
    ...
    override fun getTrekById(trekId: String): Flow<NavigatorTrek?> {
        return queries.getNavigatorTrekById(trekId)
            .asFlow()
    ...
    override fun getAllNavigatorTreks(): Flow<List<NavigatorTrek>> {
        return queries.getAllNavigatorTreks()
            .asFlow()
            .mapToList(Dispatchers.IO)
            .map { trekEntities ->
